...
class MQ9():
    ...
    def __init__(self, Ro=10):
        ...
        # create an analog input channel on pin 7 for MQ9
        self.chan_MQ9 = AnalogIn(mcp, MCP.P7)
    ...
    def MQ9_Calibration(self):
        ...
        for i in range(self.CALIBRATION_SAMPLE_TIMES):          # take multiple samples
            val += self.MQResistanceCalculation(self.chan_MQ9.value)
    ...
    def MQRead(self):
        ...
        for i in range(self.READ_SAMPLE_TIMES):
            raw_value += self.chan_MQ9.value
            rs += self.MQResistanceCalculation(self.chan_MQ9.value)
